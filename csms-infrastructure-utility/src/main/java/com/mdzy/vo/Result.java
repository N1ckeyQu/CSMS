...
import com.mdzy.exception.MessageCode;
...
public class Result<T> implements Serializable {
  ...
  public static Result success() {
    return new Result(
        MessageCode.SUCCESS.getStatus(), MessageCode.SUCCESS.getMessage(), MDC.get(TRACE_LOG_ID));
  }
